...
class Dashboard_Form_SearchForm extends Zend_Form
{
    ...
    public function init()
    {
		...
		$startGroup = $this->addDisplayGroup(array($leavingFrom, $goingTo), 'start',array('tag'=>'div','style'=>	        'width:93%;
		float:left;
		background:;
		opacity:1.0;
		...
		$typeGroup = $this->addDisplayGroup(array($trailerTypeFlatBed,$trailerTypeVan,$trailerTypeTanker,$trailerTypeStrectTrailer), 'type',array('tag'=>'div','style'=>	        'width:93%;
		float:left;
		background:;
		opacity:1.0;
  		filter:alpha(opacity=1.0); /* For IE8 and earlier */
